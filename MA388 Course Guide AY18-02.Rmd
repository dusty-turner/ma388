...
Throughout MA388 we will use the 2nd edition of Jared Lander's textbook, **R For Everyone**.  
...
playersselected = 
  players %>%
  select(playerID, yearID, AB, GamesBatting, GamesField, SBBatting, CSBatting)
