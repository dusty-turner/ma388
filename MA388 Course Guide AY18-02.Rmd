...
1. Interpret the results of a logistic regression model in terms of a real world situation.

2. Build a logistic regression model using appropriate model building techniques. 
...
1. Given two models, determine which model is the "better" model.
