...
|Familiarize|Watch|Suggested Problems|
|-------------------|-----------------|-----------|
|Lander Chapter 12 |  | Suggested Problems Below | 
...
3. Randomly select 25% of the data.

4. Select all rows which occured since 1975.

5. Rename Column headers so that they are easier to understand.

5. Filter the data by playerID, G, AB, R, H
...
players = 
  players %>%
  select(playerID, yearID, GamesBatting, GamesField, SBBatting, CSBatting)
