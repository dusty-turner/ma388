...
|Familiarize|Watch|Suggested Problems|
|-------------------|-----------------|-----------|
|Devore 8.1, | **<a href="https://www.youtube.com/watch?v=cpL38ZeIecE" target="_blank">Hypothesis Testing</a>** | Problems | 
...
|Familiarize|Watch|Suggested Problems|
|-------------------|-----------------|-----------|
|Reading |**<a href="https://www.youtube.com/watch?v=66z_MRwtFJM" target="_blank">SLR in R</a>**| Problems | 
...
2. Create a Normal Probability plo in R.
...
## Lesson 22 - Introduction to Logistic Regression
...
## Lesson 23 - Testing Signficance of Coefficients
...
## Lesson 24 - Interpretation of Fitted Logistic Regresion Models
...
## Lesson 25 - Assessing Fit: ROC Curves and Classification
...
## Lesson 26 - Logistic Regression Diagnostics
...
## Lesson 27 - Model Building With Logistic Regression
...
## Lesson 28 - Problem Solving Lab 2 
...
4. Think of 2 baseball related problems you could model with Survival Analysis and 2 non baseball prolbems.  
...
Let the number at risk of dying at $t_{(i)}$ be denoted $n_{i}$ and the oberved number of deathrs be denoted $d_{i}$.
...
Read and prepare data.  We will discuss the nuances of this dataset in class.  
...
This form (exponentiated) is necessary to aid finding the $\beta$ coefficients that maximise the MLE.  
...
If $x$ is a dicotomus variable.  If x is present ($x=1$ vs $x=0$), then your subjects are dying at twice the rate as the base populations.
...
A Hazard Ratio > 1 means death is more likely for the presense or increase in that factor.<br>
A Hazard Ratio < 1 means death is less likely for the presense or increase in that factor.<br>
...
We can run our Cox Proportional Hazards Model on our survival fuction.
...
4. Understand the liklihood ratio test and what that says about the model.  
...
Using the R Output from the previous lesson and refrencing the reading link, answer the following questions:
...
1. Which models are considered "significant" to a coachers survival?
...
4. How do we get the harzard ratio from the regression coefficient?
...
|Familiarize|Watch|Suggested Problems|
|-------------------|-----------------|-----------|
| Supplimental Reading |  | Suggested Problems Below | 

In order to select a **best** model when using survival analysis, use the following steps.  This process is called Purposeful Selection.  This process is a summarised version of the methodology taught by Hosmer, Lemeshow, Sturdivant in *Applied Logistic Regression, Third Edition*
...
3. Iterativly remove factors: Remove factors one at a time by highest P Value.  Collapse discrete factors which are not signficant one at a time into their base level.
...
Using the `managerssurvival.csv` dataset from the course sharepoint, use purposeful selection to create a model.  
...
3. Indentify Influential and Poorly Fit Subjects.
...
## Lesson 39 - Project Presentation Part 3 
